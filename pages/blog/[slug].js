...
export async function getStaticPaths() {
    const table = await fetch(`https://notion-api.splitbee.io/v1/table/5a6fc926e63441bf9492f7fb89fdc114`).then((res) => res.json());
    return { paths: table.map((row) => `/blog/${row.slug}`), fallback: false };
}